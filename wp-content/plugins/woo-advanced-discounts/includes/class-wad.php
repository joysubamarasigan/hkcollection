...
class Wad {
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'enqueue_scripts' );
                ...
                $this->loader->add_action( 'woocommerce_order_amount_total_discount', $discount, 'get_total_cart_discounts', 99, 2 );
...
//                $this->loader->add_filter( 'woocommerce_variation_prices_price', $discount, 'get_regular_price', 99, 2 );
                $this->loader->add_filter( 'woocommerce_variation_prices_sale_price', $discount, 'get_sale_price', 99, 2 );
                $this->loader->add_filter( 'woocommerce_variation_prices', $discount, 'get_variaion_prices', 99, 2 );
