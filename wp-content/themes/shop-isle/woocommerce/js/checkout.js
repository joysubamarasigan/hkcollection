...
jQuery( function( $ ) {
	...
	var wc_checkout_form = {
		...
		init: function() {
			...
			$('input.shipping_method:not(:checked)').parent().addClass('hide_shipping_class');
		},
		on_state_change: function(){
			if($(this).val() != '00'){
				$('input.shipping_method').parent().removeClass('hide_shipping_class');
				$('input[value="main"]').parent().addClass('hide_shipping_class');
			}
		},
		...
		init_checkout: function() {
			$( '#billing_country, #shipping_country, #billing_state, #shipping_state, .country_to_state' ).change();
		...
		update_checkout_action: function( args ) {
			...
			if($('#billing_state').val() != '00'){
				$('input.shipping_method[value!="main"]').attr('checked',true);
				$('input.shipping_method[value="main"]').attr('checked',false);
				$('input.shipping_method[value!="main"]').parent().removeClass('hide_shipping_class');
				$('input.shipping_method[value="main"]').parent().addClass('hide_shipping_class');
			}
			else{
				$('input.shipping_method[value!="main"]').attr('checked',false);
				$('input.shipping_method[value="main"]').attr('checked',true);
