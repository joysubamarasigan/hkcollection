		...
		<footer class="footer bg-dark">
			...
			<div class="container">
				...
				<div class="row">
					...
					$shop_isle_socials = get_theme_mod('shop_isle_socials',json_encode(array( array('icon_value' => 'social_facebook' ,'link' => '#' ),array('icon_value' => 'social_twitter' ,'link' => '#'), array('icon_value' => 'social_instagram' ,'link' => '#'), array('icon_value' => 'social_viber' ,'link' => '#') )));
